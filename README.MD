...
## 📸 Screenshots
https://apkpure.com/trimurl-url-shortener/com.tajim.urlshortener
---

| Login                      | Dashboard                      | Create URL                      | Modern Menu                  |
| -------------------------- | ------------------------------ | ------------------------------- | ---------------------------- |
...
buildTypes {
    ...
    release {
        buildConfigField "String", "SERVER_BASE_URL", "\"https://go.tajimz.xyz\""
    }
}
```
...
Built by **Tajim**
🌐 [https://trtajim.xyz](https://trtajim.xyz)
